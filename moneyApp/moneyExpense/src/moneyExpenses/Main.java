...
public class Main {
	private static final String urlPath = "http://data.fixer.io/api/latest?access_key=0bf3f5aae9ea02ab08c626e23e1dd349";
	...
	public static void programRun() {
		String data;
		while (working) {
			System.out.println("Commands: add, list, clear, total, help, exit");
	...
	public static List<String> addParser(String data) {
		...
		System.out.println("Please, use correct format: add 2018-06-22 12 USD Jogurt");
	...
	public static void commandClear(String data) {
		...
		if (dataArray.size() == 2 && isValidDate(dataArray.get(1))) {
			...
			System.out.println("Please, use correct format: clear 2018-06-22");
		}
	}
	...
	public static void commandHelp() {
		System.out.println("===========================================================");
		System.out.println("Commands: add, list, clear, total, help, exit");
		System.out.println("Correct commands format example 'add 2018-06-22 12 USD Jogurt'");
		System.out.println("list");
		System.out.println("clear 2018-06-22");
	...
	public static boolean isValidDate(String date) {
		...
		System.out.println("Please, use right input format for date: YYYY-mm-dd (2018-06-22) and year must be between 2000-2050");
		return false;
	}
